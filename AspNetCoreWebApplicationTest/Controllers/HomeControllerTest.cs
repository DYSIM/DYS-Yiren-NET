...
namespace AspNetCoreWebApplicationTest.Controllers
{
    public class HomeControllerTest
    {
        ...
        public void IndexTest()
        {
            ...
            Assert.Equal("You just created a ASP.Net Core web application!!QWEQWEQD", result.ViewData["Message"]);
        }
        ...
        public void ErrorTest()
        {
            ...
            Assert.Single(result.ViewData);
            Assert.Equal("We've encountered an error :( QWEQWDQW", result.ViewData["Message"]);
        }
    }
}
